    ...
    <div class="row"> 
        ...
        <div class="full-row">
            <div class="container">
                    <div class="row">
						<div class="col-lg-12">
							<h2 class="text-secondary double-down-line text-center" style="margin-top: 22px;">Profile</h2>
                        </div>
					</div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-5 col-md-12">
								<?php 
									...
									{
								?>
                                <div class="user-info mt-md-50"> <img src="" alt="userimage" class="avatar-img rounded-circle">
                                    <div class="mb-4 mt-3">
