            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <a href="addtocart.php?pid=<?php echo $row['0'];?>"><i class="fa-solid fa-heart fa-bounce"></i></a>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="text-left text-md-right" style="font-weight:bold;color:black">Price</div>
                            </div>
                        </div>
